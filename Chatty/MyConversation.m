...
@synthesize people, conversation;
...
- (id)initWithStyle:(UITableViewStyle)style
{
    ...
    if (self) {
        ...
        conversation = [[NSMutableArray alloc] initWithObjects:@"Nazish: Dude I'm going to India", @"Omar: What did drake say when he was sitting on a mexican?", @"Danish: I look good", @"Diviya: I baked you a cupcake guys :)", @"Kassam: Our revenues are through the roof", nil];
    }
    return self;
}
